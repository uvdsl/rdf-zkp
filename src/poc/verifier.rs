...
use super::super::{
    rdf4zkp::{encoder::Rdf2FrInMemoryEncoder, quads_list::QuadsList},
    zkp4rdf::{
...
pub fn verify() {
    let file = BufReader::new(File::open("./data/prover.trig").unwrap());
    ...
    println!(
        "Time taken to verify proof of 35 msg POKS, with 1 RANGE and 1 NON-MEMBER: {:#?}, {:?}",
        start.elapsed(),
        result
    );
}
